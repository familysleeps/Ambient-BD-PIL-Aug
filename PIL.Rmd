...
* Live near Maynooth
* Willing to have researchers visit your home
...
2. Fit a bedside sensor that monitors movement and environment in your bedroom for 3 months (see image below).  The sensor records the following information:
    ...
    * Light  
    ...
    \item[] The sensor has its own internet connection and you will not be able to download the data or access the sensor controls.  It is unobtrusive and makes no sound, and has no display.  If you go on holiday or stay somewhere else overnight, we will ask you to bring their bedside sensor, if possible.   
